...
public:
    ...
    void swap(SingleLinkedList& other) noexcept {
        std::swap(size_, other.size_); // обмениваем размер
        std::swap(head_.next_node, other.head_.next_node); // обмениваем указатель на голову списка
    }
    ...
    Iterator InsertAfter(ConstIterator pos, const Type& value) {
        ...
        // ставим его в необходимое место
    ...
    void PopFront() noexcept {
        ...
        if(0 == size_)
            return;
        // указатели на первый узел и следующий за первым
